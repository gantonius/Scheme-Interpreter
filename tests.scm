...
(eval (car (quote (1 2 4 . 5))))
; expect 1

'(1 (2 sevennineteneleventwelve . (9 . 11)))
; expect (1 (2 sevennineteneleventwelve 9 . 11))
...
(eval (define hello (begin (+ 3 4) (+ 3 3))))
; expect 6
...
(eval (define (triangle x y) (* 0.5 x y)))
; (lambda (x y) (* 0.5 x y))
...
(and (and 1 False) (or True False))
; expect False

(or (and 1 False) (or 5 False))
; expect 5
